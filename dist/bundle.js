...
/* harmony export */   submitInitialForm: () => (/* binding */ submitInitialForm)
/* harmony export */ });
...
function createTask(title, date, description, project) {
    (0,_taskManager__WEBPACK_IMPORTED_MODULE_0__.createToDo)(title, date, description, project);
    displayAllTasks()
    displayProjects()
...
function editTask(currentTask, title, date, description, project){
    (0,_taskManager__WEBPACK_IMPORTED_MODULE_0__.updateToDo)(currentTask, title, date, description, project)
    displayAllTasks()
    displayProjects()
    setFormMode('undefined')
}
...
function handleCheck(evt){
    if (evt.target.closest('.task-check')){
        ...
        ;(0,_taskManager__WEBPACK_IMPORTED_MODULE_0__.toggleCompletetion)(task)
...
function updatePrjctDropdown(){
    selectEl.innerHTML = ''
    _taskManager__WEBPACK_IMPORTED_MODULE_0__.projects.forEach(project => { 
...
function handleDelete(evt){
    if (evt.target.classList.contains("delete-svg")){
        ...
        ;(0,_taskManager__WEBPACK_IMPORTED_MODULE_0__.deleteTask)(taskObj, parentProject.name)
        displayAllTasks()
        displayProjects()
    }
}
...
function getClickedTask(evt) {
    ...
    if (taskEl){
        ...
        const project = _taskManager__WEBPACK_IMPORTED_MODULE_0__.projects.find(p => p.name === taskProject);
...
function handleProjectForm(e){
    ...
    e.preventDefault()
    ;(0,_taskManager__WEBPACK_IMPORTED_MODULE_0__.createProject)(projectName)
    titleInput.value = ''
    displayProjects()
}
...
function displayProjects(){
    ...
    for (let project of _taskManager__WEBPACK_IMPORTED_MODULE_0__.projects){
...
/* harmony export */   toggleCompletetion: () => (/* binding */ toggleCompletetion),
...
document.addEventListener('DOMContentLoaded', function() {
    (0,_domHandler__WEBPACK_IMPORTED_MODULE_0__.initializeEventListeners)();
    (0,_domHandler__WEBPACK_IMPORTED_MODULE_0__.initialState)()
});
